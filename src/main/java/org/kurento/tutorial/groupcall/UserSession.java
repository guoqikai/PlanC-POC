...
public class UserSession implements Closeable {
  ...
  public void stopReceiveFrom(UserSession sender) {
    WebRtcEndpoint incoming = incomingMedia.get(sender.getName());
    if (incoming == null)
      return;
    sender.getOutgoingWebRtcPeer().disconnect(incoming);
    log.info("Stop Receive");
  }

  public void continueReceiveFrom(UserSession sender) {
    WebRtcEndpoint incoming = incomingMedia.get(sender.getName());
    if (incoming == null)
      return;
  ...
  public void cancelVideoFrom(final String senderName) {
    ...
    incoming.release(new Continuation<Void>() {
      ...
      public void onSuccess(Void result) throws Exception {
        log.trace("PARTICIPANT {}: Released successfully incoming EP for {}", UserSession.this.name, senderName);
      }
